...
x1, y1, r1 = int(input("1-я окружность X = ")), int(input("1-я окружность Y = ")), abs(int(input("1-я окружность R = ")))
x2, y2, r2 = int(input("2-я окружность X = ")), int(input("2-я окружность Y = ")), abs(int(input("2-я окружность R = ")))
