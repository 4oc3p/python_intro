...
x1, y1, r1 = int(input("1-я окружность X = ")), int(input("1-я окружность Y = ")), int(input("1-я окружность R = "))
x2, y2, r2 = int(input("1-я окружность X = ")), int(input("1-я окружность Y = ")), int(input("1-я окружность R = "))
